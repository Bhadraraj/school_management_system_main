                      ...
                      >
                        <td className="py-4 px-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="font-medium text-foreground whitespace-nowrap group-hover:text-accent-foreground">
                              {teacher.name}
                            </span>
                          </div>
                        </td>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="text-base whitespace-nowrap font-semibold text-foreground">
                            {teacher.name}
                          </h3>
